        ...
        <div class="page-content">
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3 class="breadcrumb-header">修改產品</h3>
                </div>
                <div id="main-wrapper">
                            ...
                            <div class="panel-body">
                                <form id="products_form" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="product_name" class="form-control" id="input-Default" value="<?= $product["product_name"] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="product_class_id" class="selectpicker" data-live-search="true" onChange="select_product_class(this.options[this.selectedIndex].value)">
                                                <? foreach ($product_class as  $product_class_item) { ?>
                                                    <option <? if ($product_class_item["product_class_id"] == $product["product_class_id"]) {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="product_price" class="form-control" id="input-Default" value="<?= $product["product_price"] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">特價</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="product_special_price" class="form-control" id="input-Default" value="<?= $product["product_special_price"] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">排序</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="product_sequence" class="form-control" id="input-Default" value="<?= $product["product_sequence"] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="box-body" id="product_pic_div">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="checkbox">
                                                <label>
                                                    <span><input name="product_is_use" <? if ($product["product_is_use"] == 1) {
                                                                                            echo "checked='checked'";
                                                                                        } ?> type="checkbox"></span> 是否上架
                                                </label>
                                            </div>
                                        </div>
                                    </div>
